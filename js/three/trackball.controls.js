		...
		constructor(object, domElement) {
			...
			this.rotateCamera = function () {
				const axis = new THREE.Vector3(),
					...
					moveDirectionX = new THREE.Vector3(),
                    moveDirectionY = new THREE.Vector3();
                    
				return function rotateCamera() {
					moveDirectionX.set(_moveCurr.x - _movePrev.x, 0, 0);
                    moveDirectionY.set(0,_moveCurr.y - _movePrev.y, 0);
					let angleY = moveDirectionX.length();
					if (angleY) {
						...
						moveDirectionX.copy(objectSidewaysDirection);
						axis.crossVectors(moveDirectionX, _eye).normalize();
						angleY *= scope.rotateSpeed;
						quaternion.setFromAxisAngle(axis, angleY);
